...
@Controller
@SessionAttributes({"sesionBoletos"})
public class BoletosCompraController {
    ...
    public String inicioSlash(Model model) {
        ...
        List<Boleto> boletos = (List<Boleto>) model.getAttribute("sesionBoletos");
    ...
    public String agregarBoleto(Model model, @ModelAttribute Boleto boleto) {
        ...
        model.addAttribute("sesionBoletos", boletos);
        model.addAttribute("ciudades", ciudades);
        model.addAttribute("boleto", new Boleto());
